...
изображения, видео или аудио. Язык и замысел исходного текста сохраняются.
Если во время запроса изменились текст, режим, настройки или референсы, устаревший
...
Ответ: `{"prompt": "Полный улучшенный промпт…", "model": "deepseek-v4-pro-260425"}`.
